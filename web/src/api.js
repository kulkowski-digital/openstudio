...
export const api = {
  ...
  infographicExtract: (payload) => call('/api/infographic/extract', { method: 'POST', body: JSON.stringify(payload) }),
  infographicOutline: (text, useModel) => call('/api/infographic/outline', { method: 'POST', body: JSON.stringify({ text, useModel }) }),
  infographicPrompt: (outline, layout) => call('/api/infographic/prompt', { method: 'POST', body: JSON.stringify({ outline, layout }) }),
